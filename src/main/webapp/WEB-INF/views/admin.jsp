...
<head>
  ...
  <link href="${pageContext.servletContext.contextPath }/resources/admin/vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet">
  <!-- Custom styles for this template-->
  <link href="${pageContext.servletContext.contextPath }/resources/admin/css/sb-admin.css" rel="stylesheet">
</head>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="editorsPick">
          <i class="fas fa-fw fa-table"></i>
          <span>Editor's Pick</span></a>
      </li>
    </ul>
    ...
    <div id="content-wrapper">
      ...
      <c:choose>
        <c:when test="${name eq 'main'}">
            <c:import url="./admin/adminmain.jsp"/>
        </c:when> 
        <c:when test="${name eq 'editorspick'}">
            <c:import url="./admin/editorspick.jsp"/>
        </c:when> 
        <c:otherwise>
            ${name}
        </c:otherwise>
  ...
  <script src="${contextPath}/resources/admin/vendor/datatables/jquery.dataTables.js"></script>
  <script src="${contextPath}/resources/admin/vendor/datatables/dataTables.bootstrap4.js"></script>

  <!-- Custom scripts for all pages-->
  <script src="${contextPath}/resources/admin/js/sb-admin.min.js"></script>
